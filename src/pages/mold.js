...
export class HeroPageMold extends React.Component {
  constructor(props) {
    super(props);
      ...
      <div>
        ...
        >
          <div>
            <div>
              <div
                style={{ position: "absolute", zIndex: 8999, width: "100%" }}
              >
                <div
                  style={{
                    paddingTop: 80,
              ...
              <div
                className="myDIV photoCoverBG"
                style={{
                  minHeight: 788,
                  backgroundImage:
                    "url(" + this.state.content.imageURLArray[0] + ")",
                }}
              ></div>
            </div>
          </div>
          <div className="bg-mainColor">
            <div>
                ...
                >
                  <div style={{ maxWidth: "98vw" }}>
                    ...
                    >
                      <img
                        ...
                        src={this.state.content.imageURLArray[2]}
                        alt=""
                        width="50%"
                      />
                    </div>
                  ...
                  <div style={{ maxWidth: "98vw" }}>
                    <div
                      className={`${
                        this.state.content.hasScroll &&
                        "scroll-element js-scroll slide-right starting"
                      }`}
                      style={{ minWidth: 300, padding: 30 }}
                    >
                      <h3
                        style={{
                          fontSize: 40,
                      ...
                      <p
                        style={{
                          ...
                          whiteSpace: "break-spaces",
                          paddingBottom: 10,
                          borderBottom: `1px solid ${this.state.content.font}`,
                          color: this.state.content.font,
                        }}
                      >
              ...
              <div
                className={`photoCoverBG`}
                style={{
                  color: this.state.content.font,
                  fontSize: 20,
                  paddingBottom: 5,
                  backgroundImage:
                    "url(" + this.state.content.imageURLArray[1] + ")",
                }}
              >

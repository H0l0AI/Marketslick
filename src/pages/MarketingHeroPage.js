...
export const HeroContent = (props) => (
  <div
    style={{
      backgroundColor: props.content.backgroundType,
    ...
    <div className="container">
      <div className="row align-items-center noXGutter">
        <div className="col-12 col-md-5 offset-md-1">
          ...
          >
            <h3 style={{ fontSize: 36 }} className="mb-4">
              {props.content.titleContent}
            </h3>
            <p clas="mb-4">{props.content.titleBlurb}</p>
            <a
              onClick={() => {
                window.location.href = props.content.mainButtonLink;
              }}
            ...
            >
              ...
              {props.content.mainButtonTitle || "Your shop link here"}
            </a>
          </div>
        </div>
        <div className="col-12 col-md-5">
          <img
            ...
            src={
              props.content.imageURLArray
                ? props.content.imageURLArray[0]
                : logo
            }
    ...
    <div>
      <div className={`scroll-element js-scroll fade-in-bottom starting`}>
        <div className="row align-items-center noXGutter">
          ...
          <div className="col-12 col-md-5">
            <div className="px-4">
              <h3 style={{ fontSize: 28 }} className="mb-4">
                {props.content.supportingHeading}
              </h3>
      ...
      <h3 style={{ fontSize: 28, marginTop: 140 }} className="mb-5 text-center">
        <span className="mx-auto d-inline-block rounded-pill bg-white border p-4 mb-0 shadow text-dark">
          {props.content.p3Heading1}
        </span>
      </h3>
      <p className="mb-4" style={{ textAlign: "center" }}>
        {props.content.p3Content1}
      </p>
    </div>
  </div>
);
export const AuxiliaryContent = (props) => (
  <div
    className={`py-6`}
    style={{
      backgroundColor: props.content.backgroundType,
    ...
    <div>
      <div className={`scroll-element js-scroll fade-in-bottom starting`}>
        <h3 style={{ fontSize: 28 }} className="mb-5 text-center">
          <span className="mx-auto d-inline-block rounded-pill bg-white border p-4 mb-0 shadow text-dark">
            {props.content.secondaryContentTitle}
          </span>
        </h3>
      </div>
  ...
  return (
    ...
    >
      ...
      <div className="row row-eq-height text-white">
        <div className="col-12 col-md-5 offset-md-1">
          <div
            className={`scroll-element js-scroll ${
              props.index % 2 === 0 ? "slide-left" : "slide-right"
            } `}
          >
            <div className="bg-dark p-4 rounded-4">
              ...
              <div style={{ display: "flex", justifyContent: "center" }}>
                <img
                  ...
                  src={(route.imageURLArray && route.imageURLArray[0]) || logo}
                  alt=""
                  width="50%"
                />
              </div>
        ...
        <div className="col-12 col-md-5">
          <div
            className={`scroll-element js-scroll ${
              props.index % 2 === 0 ? "slide-right" : "slide-left"
            } `}
          >
...
export const Footer = (props) => (
  <>
    <div
      className={`py-6`}
      style={{ backgroundColor: props.content.class, color: "#fff" }}
    >
      <div>
        <div className={`scroll-element js-scroll fade-in-bottom starting`}>
            ...
            <div className="px-4">
              <div>
                <div
                  ...
                  className="bg-dark p-4 rounded-4 mt-4 mt-md-0"
                >
                ...
                <div style={{ display: "flex", justifyContent: "center" }}>
                  {props.content.mapsCenter && (
                    <SimpleMap
                      center={props.content.mapsCenter}
                      name={props.content.businessName}
                    />
                  )}
                </div>
              </div>
...
export const NavBar = (props) => (
  <nav
    style={{ backgroundColor: props.content.class }}
    ...
    return (
      <div>
        <NavBar
          ...
          isMarketing={true}
          class={this.state.content.class}
          routeItems={
        ...
        <div>
          {this.state.content.routeItems &&
            this.state.content.routeItems.map((i, ix) => {
              return (
                <AdditionalContent content={this.state.content} index={ix} />
              );
            })}
        </div>
